...
def listing(request, id):
    ...
    if request.method == "POST":
        ...
        if action == "Watchlist":
            ...
            if content:
                comment = Comment(
                    auction_listing=listing, author=request.user, content=content
                )
                comment.save()
        elif action == "Bid":
            try:
...
def watchlist(request):
    ...
    return render(request, "auctions/watchlist.html", {"items": watchlisted_items})
...
def categories(request, category):
    ...
    if request.method == "GET":
        return render(
            ...
            {"category": category, "categories": categories, "listings": listings},
        )
